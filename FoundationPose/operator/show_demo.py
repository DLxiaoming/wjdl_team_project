...
if __name__ == "__main__":
    ...
    left_arm = mmk2.get_arm_ee_pose('left_arm')
    # right_arm = mmk2.get_arm_ee_pose('right_arm')
    print("left_arm: ", left_arm)
    # print("right_arm: ", right_arm)
    mmk2.set_robot_eef('left_arm', 1.0)
    # pose_base = [0.8868162429374099, 0.21029169690800675, 1.2452051635026589, -0.016453529876487794, 0.16611498795436896, -0.1737661554229103, 0.9705361484051299]
    ...
    # # 初始
    # pose_base_0 = [0.4859938037517418, 
    #                 0.055757196060511154, 
    #                 0.9705575699689777,
    #                 0.0065230677285969575, 
    #                 -0.0024745692612586382, 
    #                 -0.6897490760254816, 
    #                 0.7240148743060282]


    # # 目标上方
    # pose_base_1 = [0.618581849981374, 
    #                 0.240754608410472,   #
    #                 0.9078679964563538,
    #                 0.050183433489506546, 
    #                 0.10387511105028661, 
    #                 -0.5086898622164255, 
    #                 0.8531859166592759]
    # # 目标处
    # pose_base_2 = [0.618581849981374, 
    #                 0.240754608410472, 
    #                 0.8878679964563538,
    #                 0.050183433489506546, 
    #                 0.10387511105028661, 
    ...
    # # 夹取后目标上方
    # pose_base_3 = [0.6144294719004361, 
    #                 0.24084802859458573, 
    #                 0.9480283634570601,
    #                 0.00694709442188559, 
    #                 0.014578243789290261, 
    #                 -0.5631457414295962, 
    #                 0.8261997861273166]
    # # pose_base_3 = [0.6144294719004361, 
    # #                 0.24084802859458573, 
    ...
    # #                 0.8261997861273166]
    # # 旋转0
    # pose_base_4 = [0.7398144098493437, 
    #             0.14044728460199593, 
    #             1.0365918647263495, 
    #             -0.010012720567288795, 
    #             -0.09803456778845106, 
    #             -0.4622572162276495, 
    #             0.8812532184286405]
    
    # # 旋转0.3
    # pose_base_5 = [0.7400452315282439, 
    #             0.14125469620206577, 
    #             1.0377178977800396,
    #             -0.30645827670186016, 
    #             0.06668545887498935, 
    ...
    # # 旋转0.7
    # pose_base_6 = [0.7409708630395192, 
    #             0.14345232602917593, 
    #             1.046079481067637,
    #             0.8201338261888268, 
    #             -0.3870346561342286, 
    ...
    # # 旋转1
    # pose_base_7 = [0.7458192234106297, 
    #             0.1435418564754987, 
    #             1.045525194319876,
    #             0.8913280347410203, 
    #             -0.43643112921672184, 
    #             0.1225677204312551, 
    #             0.006273582996434215]
    
    # # 前伸
    # pose_base_8 = [0.7186004485978165, 
    #             -0.004304313416739165, 
    #             1.08213178148838,
    #             0.8401350894854357, 
    #             -0.5348298350767813, 
    #             0.0901645636884652, 
    #             -0.0006560349920042296]
    # # pose_base_8 = [0.7186004485978165, 
    # #             -0.014304313416739165, 
    # #             1.02213178148838,
    # #             0.8401350894854357, 
    # #             -0.5348298350767813, 
    # #             0.0901645636884652, 
    # #             -0.0006560349920042296]
    # # 下压
    # pose_base_9 = [0.7265763187566567, 
    #             -0.014635647142899553, 
    #             0.9607150542407682,
    #             0.9291561549797398, 
    #             -0.3687214810908031, 
    #             0.02512955772720347, 
    #             0.009045129844589186]

    # # 目标位置下前伸
    # pose_base_10 = [0.6579691402785715, 
    #             -0.07886238347355441, 
    #             0.9622247424956383,
    #             0.8922427102492431, 
    #             -0.44834864152819454, 
    #             0.0034028508721435447, 
    #             0.05361774195963194]


    # pose_base_11 = [0.6571187117432126, 
    #                 -0.058624824793340496, 
    #                 0.9737326734909322,
    #                 0.8798147510291262, 
    #                 -0.4504193366704257, 
    #                 0.10937233156145472, 
    ...
    # pose_base_12 = [0.6571187117432126, 
    #                 -0.058624824793340496, 
    #                 0.9737326734909322,
    #                 0.8798147510291262, 
    #                 -0.4504193366704257, 
    ...
    # pose_base_13 = [0.6571187117432126, 
    #                 -0.058624824793340496, 
    #                 0.9937326734909322,
    #                 0.8798147510291262, 
    #                 -0.4504193366704257, 
    #                 0.10937233156145472, 
    #                 0.10529063640106612]
    # pose_base_14 = [0.6571187117432126, 
    #                 -0.058624824793340496, 
    #                 1.0337326734909322,
    #                 0.8798147510291262, 
    #                 -0.4504193366704257, 
    ...
    #                 0.10529063640106612]
    # mmk2.set_robot_eef('left_arm', 1.0)
    # # mmk2.control_arm_pose('left_arm', pose_base_13)
    ...
    # elif state == "reset":
    #     mmk2.set_robot_eef('left_arm', 1.0)
    #     # mmk2.control_arm_pose('left_arm', pose_base_7)
    #     mmk2.control_arm_pose('left_arm', pose_base_0)
    # else:
    #     mmk2.set_robot_eef('left_arm', 1.0)
    #     mmk2.control_arm_pose('left_arm', pose_base_0)
    #     mmk2.control_arm_pose('left_arm', pose_base_1)
    #     mmk2.control_arm_pose('left_arm', pose_base_2)

    #     mmk2.set_robot_eef('left_arm', 0.0)
    #     mmk2.control_arm_pose('left_arm', pose_base_3)

    #     mmk2.control_arm_pose('left_arm', pose_base_4)
    #     # mmk2.control_arm_pose('left_arm', pose_base_5)
    #     # mmk2.control_arm_pose('left_arm', pose_base_6)

    #     mmk2.control_arm_pose('left_arm', pose_base_7)
    #     mmk2.control_arm_pose('left_arm', pose_base_8)
    #     # mmk2.control_arm_pose('left_arm', pose_base_9)
    #     # mmk2.control_arm_pose('left_arm', pose_base_10)

    #     mmk2.control_arm_pose('left_arm', pose_base_11)
    #     mmk2.control_arm_pose('left_arm', pose_base_12)
    #     mmk2.control_arm_pose('left_arm', pose_base_13)
    #     mmk2.control_arm_pose('left_arm', pose_base_14)

    # # KP01 = {
    # #     MMK2Components.LEFT_ARM: JointState(position=[0.7974541927616633, 
    # #                                                     0.3080003094629812, 
    # #                                                     0.8882755128192314, 
    # #                                                     34.620,
    # #                                                     2.715,
    ...
    # #     MMK2Components.LEFT_ARM_EEF: JointState(position=[1.0]),
    # # }
    # # mmk2.control_trajectory_full(KP01)
